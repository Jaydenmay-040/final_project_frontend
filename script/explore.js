      ...
      .then((data) => {
        ...
        posts.forEach((post) => {
          ...
          if (post.user_id != window.localStorage.user_id) {
            document.querySelector(
              ".postContainer"
                                ...
                                <div class="user_info">
                                    ...
                                    <h1 class="username">${post[1]}</h1>
                                </div>
                                <div class="post">
                                    <p class="post_content">${post[4]}</p>
                                </div>
                                <div class="reactions">
                                <i class="fas fa-heart like" id="${post[0]}"></i>
                                ...
                                <div class="post_content_modal">
                                    ...
                                    <div id="top_post">
                                        <div class="post_info">
                                        <img class="post_icon" src="${post[3]}" alt="">
                                        <h1 class="post_username">${post[1]}</h1>
                                        </div>
                                        <div class="post_post">
                                        <p class="post_post_content">${post[4]}</p>
                                        </div>
            ...
            fetch(
              `https://blooming-castle-04766.herokuapp.com/comment/${post[0]}/`,
              {
                method: "GET",
                headers: {
